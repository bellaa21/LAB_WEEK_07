...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // the activvity result will be used to handle the permission request to the user
        ...
        requestPermissionLauncher =
            registerForActivityResult(ActivityResultContracts.RequestPermission()){
                ...
                // A rationale dialog is used for a warning to the user that the appa will
    ...
    // This is used to check if the userd already has the permission granted
    ...
    //A rationale dialog is used for a warning to the user that the app will no work without the required permission
    ...
    private fun showPermissionRationale(positiveAction: () -> Unit){
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage("This is app will not work knowing your current location")
